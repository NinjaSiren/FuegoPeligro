...
public class Wordscapes implements Disposable {
    private static final String QUESTION_LABEL = "CHECKPOINT: WORDSCAPES";
    ...
    public Wordscapes(final Batch batch, final AssetManager assets, final FuegoPeligro game, final LevelGraphicsProcessor levelGraphicsProcessor){
