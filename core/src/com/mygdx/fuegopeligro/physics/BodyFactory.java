...
public interface BodyFactory {
     ...
     *
     * @param world     An instance of a Box2D {@link World} used to create bodies and fixtures.
     * @param direction Indicates where the resulting body should be facing. For symmetrical or simple
     ...
     *
     * @param world      An instance of a Box2D {@link World} used to create bodies and fixtures.
     * @param definition The {@link BodyDef} that defines initial body properties.
