...
public abstract class PlayerStatusProcessor implements PlayerStatusSubject {
     ...
     * global state.
     *
     * @param status The instance of {@link CurrentPlayerStatus} that will be used internally by this
     ...
     *
     * @param character The {@link Entity} whose state is to be evaluated.
     */
     ...
     *
     * @see
     * com.mygdx.fuegopeligro.player.PlayerStatusSubject#addObserver(com.mygdx.fuegopeligro.player.PlayerStatusObserver
     * )
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.mygdx.fuegopeligro.player.PlayerStatusSubject#removeObserver(com.mygdx.fuegopeligro.player.
